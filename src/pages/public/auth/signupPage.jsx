                 ...
                 <form className=' flex flex-col'>
                    <div className=' flex flex-col w-max gap-2 content-center items-center'>
                            ...
                            <h3 className=' pt-2 pb-2 font-bold text-white text-xl'>Veillez vous inscrire</h3>
                                <div className=' flex flex-row justify-center gap-6'>
                                    <div className=' flex flex-col gap-2'>
                                          <input className='ml-8 p-2 rounded-full w-32' placeholder='Nom' {...register("firstName", { required: true })} />
                                          {errors.userFirstName && <span className=" text-red-800">Ce champ est requis.</span>}
                                    </div>
                                    <div className='flex flex-col gap-2'>
                                      <input className='mr-8 p-2 rounded-full w-32' placeholder='Prénom' {...register("secondName", { required: true })} />
                        ...
                        <div className=' flex flex-col gap-2'>
                          ...
                          <button className=' border p-2 rounded-full w-72 bg-red-400 text-white font-extrabold ' type="submit" onClick={onSubmit}>Valider</button>
